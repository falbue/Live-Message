...
**Live Message** — это простой и удобный чат с поддержкой звонков, который не требует регистрации. Создайте комнату, общайтесь и забудьте о чате, как только он вам больше не нужен
...
1. Клонируйте репозиторий:
   ```bash
   git clone https://github.com/your-repo/live-message.git
   cd live-message
   ```
